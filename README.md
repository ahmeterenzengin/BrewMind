...
**BrewMind**, doğal dil sorgularını ("_sonbaharda içimi ısıtacak tatlı ve sütlü bir kahve_", "_buz gibi ferahlatıcı hafif bir tat_") vektörlere dönüştürerek anlamsal kahve eşleştirmesi yapan ve yapay zeka baristası ile kişiselleştirilmiş tavsiyeler üreten **RAG (Retrieval-Augmented Generation)** tabanlı bir full-stack web uygulamasıdır.
...
1. **Semantik Kahve Araması:**
   - Kelime eşleşmesi yerine anlam benzerliğini arar. _"Grip oldum şifalı sıcak bir şey"_ yazıldığında menüde grip kelimesi geçmese dahi Zencefilli/Baharatlı Chai Latte ve Cortado önerilir.
