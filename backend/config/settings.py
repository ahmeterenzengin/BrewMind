...
# Veritabani: DATABASE_URL varsa (Supabase/bulut) onu kullan, yoksa Docker'a baglan
...
if DATABASE_URL:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": os.getenv("DB_NAME", "coffee_rag"),
            "USER": os.getenv("DB_USER", "coffee_user"),
            "PASSWORD": os.getenv("DB_PASSWORD", "coffee_pass"),
